...
<head>
  ...
  <title>
    Seguimiento de proyectos| Iniciar sesions
  </title>
...
<body class="">
  <div class="wrapper ">
    ...
    <div class="container-lg col-md-2 ubication-per">
        <img src="/build/img/logo-terzett.png" class="img-thumbnail border-0 sesion-terzett" alt="logo-terzett">
        <div class="form-group">
            <h3 class="titulo-center">Iniciar sesión</h3>
        ...
        <a class="btn btn-round btn-danger"href="./examples/listuser.html"> Iniciar Sesión</a>
        <div>
        </div>
    </div>
  </div>
